              ...
              <div class="card mb-3">
                <div class="card-body">
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Enter Your Email I'd & Password To Login</p>
                  </div>
                  <form class="row g-3 needs-validation"  action="logindb.jsp" method="get">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" onClick="#">Login</button>
                    </div>
                    <div class="col-12">
