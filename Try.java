...
public class Try extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      String id= request.getParameter("id");
        ...
        System.out.println("idqqqqqq"+id);
     ...
     // File fileSaveDir1 = new File(savePath);
      ...
      /*
       ...
       part.write(savePath + File.separator + fileName);
          ...
          PreparedStatement pst = con.prepareStatement("update image_table set id=?, fileName=?, path=? where id="+id);
         // pst.setInt(1, id);
		...
		pst.setString(3,savePath);
         ...
         // out.println("<center><a href='display.jsp?id=" + id + "'>Display</a></center>");
          out.println("<center><a href='TryDisplay.jsp'>Display</a></center>");
          response.sendRedirect("users-profile.jsp?id="+id);
      } catch (Exception e) {
          out.println(e);
      }
  ...
  else
  {
       ...
       // File fileSaveDir1 = new File(savePath);
        ...
        try {
            ...
            Class.forName("com.mysql.jdbc.Driver");
            Connection con1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/Booking", "root", "root");
            PreparedStatement pst1 = con1.prepareStatement("insert into image_table values(?,?,?)");
           // pst.setInt(1, id);
           // pst.setString(2, firstName);
           // pst.setString(3, lastName);
            pst1.setString(1, id);
            pst1.setString(2, dbFileName);
            pst1.setString(3, savePath);
