...
<h2 align="center"><font><strong> All Enquriy List </strong></font></h2>
<table align="center"  border="2" widht="100%"  id="export1">
<tr>

</tr>
<tr style="background-color: white">
 <td><b>Full Name&nbsp;&nbsp;&nbsp;</b></td><br>
<td><b>Email&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td><br>
<td><b>Subject &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td>
<td><b>Date &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td>
<td><b>Status &nbsp;&nbsp;&nbsp;&nbsp;</b></td>
...
connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/booking", "root", "root");
statement=connection.createStatement();
String sql ="SELECT * FROM  Enquriylist";
...
<td><a href="delete12.jsp?id=<%=resultSet.getString("id") %>"><button type="button"  style="background-color:red;color:white;width:70px;height:30px;"   class="delete" onclick="window.location='userlist.jsp';">Delete</button></a></td>
