...
<button type="button"  class="btn btn-primary" onclick="Export('export1')">Export Table</button>
       ...
       %>
       <table border='1' cellpadding='4' width='60%' id="export1">  
        <tr><th>Id</th><th>CurrencyName</th><th>CurrencyCode</th> </tr>
        <%for(Emp e:list){  
            %><tr><td><%=e.getId()%></td><td><%=e.getCurrencyName()%></td><td><%=e.getCurrencyCode()%></td></tr>  
        <%}%> 
