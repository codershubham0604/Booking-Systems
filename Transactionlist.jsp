...
<h2 align="center"><font><strong> All Transaction List </strong></font></h2>
...
<td><%=resultSet.getString("paymentMethods") %></td>
...
<% 
 ...
 if(resultSet.getString("Status").equalsIgnoreCase("active")){
	  ...
	  Status="Active";
 %>
<td><a href="activebuttondb.jsp?Status=<%=Status%>&id=<%=resultSet.getString("id") %>"><button type="button"  style="background-color:green;color:white;width:70px;height:30px;"  value="submit"><%=resultSet.getString("status") %></button></a>
</td>
